...
workspace "RUNGE_FORCA_BRUTA_BACIA"                   -- Solution Name
	...
	ok, err = os.execute("Echo y|COPY /y /v " .. SourceConfigDir .. "Kutta_header_config.h" .. " .\\_config_modelo\\")
	ok, err = os.execute("Echo y|COPY /y /v " .. SourceConfigDir .. "Nequ_config.h" .. " .\\_config_modelo\\")
